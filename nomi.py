...
def wishMe():
    ...
    speak("I am Nomi Sir  How may I help you")       
...
if  __name__ == "__main__":
    ...
    while True:
        ...
        if 'wikipedia' in query:
        ...
        elif 'open ipec live' in query:
            webbrowser.open("ipeclive.ipec.org.in")
            ...
            music_dir = "C:\\Users\\risha\\Downloads\\AI\\WhatsApp Audio 2022-09-11 at 2.45.50 PM"
            ...
            codePath = "C:\ProgramData\risha\atom\atom.exe"
            os.startfile(codePath)
            ...
            try:
                ...
                content = takeCommand()
                to = "rishabh.official.53043@gmail.com"    
